...
* https://docs.kb99.pro/s/vetis-for-1cv8/doc/proizvodstvo-produkcii-HQX8LZMQJ6
...
* Меркурий  
    * Чем отличается незавершенное производственная транзакция от завершенной?
    * Можно ли Продукция_Элемент, зарегистрированный на другой площадке, произвести на вашей площадке?
    * Какую продукцию (ВСД_Продукция_Элемент) можно произвести на площадке? 
...
5) Выпустить 5 партий продукции с помощью ВСД2_Производство

**Сдача:** 
- [ ] [пройти тестирование по теории](https://1c.kb99.pro/kb99_1c_start_w3_1.html)
- [ ] репозиторий с выгрузкой конфигурации, 
- [ ] [отчёт по практическому заданию п. 4-5](Отчет_шаблон.md) или короткое видео-демо интеграции.
